...
@Injectable()
export class RpcSearchCountriesService {
  ...
  public rpcSearchCountriesPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchCountriesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_countries`,
      args,
      {
