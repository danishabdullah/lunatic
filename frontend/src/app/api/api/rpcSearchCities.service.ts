...
@Injectable()
export class RpcSearchCitiesService {
  ...
  public rpcSearchCitiesPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchCitiesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_cities`,
      args,
      {
