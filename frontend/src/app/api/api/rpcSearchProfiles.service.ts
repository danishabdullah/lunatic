...
@Injectable()
export class RpcSearchProfilesService {
  ...
  public rpcSearchProfilesPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchProfilesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_profiles`,
      args,
      {
