...
@Injectable()
export class RpcSearchConversationsService {
   ...
   */
  public rpcSearchConversationsPost(
    args: SearchArgs,
    prefer?: string,
    observe?: 'body',
  ...
  public rpcSearchConversationsPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchConversationsPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_conversations`,
      args,
      {
