...
export class RpcMeService {
  ...
  public rpcMePost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcMePost.'
      );
    }
    ...
    return this.httpClient.post<any>(`${this.basePath}/rpc/me`, args, {
