...
@Injectable()
export class RpcSearchMessagesService {
  ...
  public rpcSearchMessagesPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchMessagesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_messages`,
      args,
      {
