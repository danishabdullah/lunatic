...
@Injectable()
export class RpcSearchUserlocationsService {
   ...
   */
  public rpcSearchUserlocationsPost(
    args: SearchArgs,
    prefer?: string,
    observe?: 'body',
  ...
  public rpcSearchUserlocationsPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchUserlocationsPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_userlocations`,
      args,
      {
