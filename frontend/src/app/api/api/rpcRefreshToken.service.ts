...
@Injectable()
export class RpcRefreshTokenService {
  ...
  public rpcRefreshTokenPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcRefreshTokenPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/refresh_token`,
      args,
      {
