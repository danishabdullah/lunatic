...
@Injectable()
export class RpcSearchUisetupsService {
  ...
  public rpcSearchUisetupsPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchUisetupsPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_uisetups`,
      args,
      {
