...
@Injectable()
export class RpcSearchMatchesService {
  ...
  public rpcSearchMatchesPost(
    ...
    if (args === null || args === undefined) {
      throw new Error(
        'Required parameter args was null or undefined when calling rpcSearchMatchesPost.'
      );
    }
    ...
    return this.httpClient.post<any>(
      `${this.basePath}/rpc/search_matches`,
      args,
      {
